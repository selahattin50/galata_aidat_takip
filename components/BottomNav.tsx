...
const BottomNav: React.FC<BottomNavProps> = ({ activeTab, onTabChange }) => {
  const tabs = [
    ...
    { id: 'sessions', label: 'Oturumlar', icon: UserCircle, active: 'border-cyan-400/55 bg-cyan-500/12 text-cyan-100 shadow-cyan-950/30', iconColor: 'text-cyan-300' },
        ...
        {tabs.map((tab) => {
          ...
          return (
            <button
              ...
              className={`relative flex min-w-0 flex-col items-center justify-center gap-1 rounded-2xl border px-1 py-1.5 transition-all duration-200 active:scale-95 ${
                isActive
